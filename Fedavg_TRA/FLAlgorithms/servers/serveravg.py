...
class FedAvg(Server):
    def __init__(self, device, dataset,algorithm, model, batch_size, learning_rate, beta, lamda, num_glob_iters,
        ...
        for i in range(total_users):
            ...
            user = UserAVG(device, id, train, test, model, batch_size, learning_rate,beta,lamda, local_epochs, optimizer,is_eligible)
    ...
    def train(self):
        ...
        for glob_iter in range(self.num_glob_iters):
            ...
            self.aggregate_parameters_with_droprate(0.1)
        #print(loss)
        self.save_results()
        self.save_model()